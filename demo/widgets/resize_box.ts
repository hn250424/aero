const html = `<div class="resizer-container" style="display: flex; justify-content: end; align-items: end;">
...
const js = `const resizeBox = document.createElement('aero-resize-box')
