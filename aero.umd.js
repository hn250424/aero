...
`;class g extends p{constructor(){super(x)}getInputSelector(){return"#input"}}customElements.define("aero-numeric-input",g);const y=`<style>\r
	:host {\r
		border: 1px solid #ccc;\r
		display: block;\r
\r
...
`;class m extends o{_$spinner;constructor(){super(w),this._$spinner=this.query("#spinner"),this._updateSpinnerStyles()}static get observedAttributes(){return["width","height","thickness","background","color","cycle"]}attributeChangedCallback(t,e,n){this._updateSpinnerStyles()}_updateSpinnerStyles(){const t=this.getAttribute("width")||"50",e=this.getAttribute("height")||"50",n=this.getAttribute("thickness")||"2",r=this.getAttribute("background")||"white",a=this.getAttribute("color")||"black",s=this.getAttribute("cycle")||"1";this.applyStyles(`
			#spinner {
				width: ${t}px;
        height: ${e}px;
        border: ${n}px solid ${a};
...
`,A={top:"90%",left:"50%",ms:3e3,background:"black",color:"white"};class u extends o{_$text;constructor(t,e){super(z);const{top:n,left:r,ms:a,background:s,color:d}=e;this._$text=this.query("#text"),this._$text.textContent=t,this.applyStyles(`
		...
		`),document.body.appendChild(this),this.addEventListener("animationend",()=>{this.remove()},{once:!0})}static show(t,e={}){const n={...A,...e};new u(t,n)}}customElements.define("aero-toast",u);const E=`<style>\r
	:host {\r
		position: fixed;\r
		top: 0;\r
		left: 0;\r
...
`,S={fontSize:"1rem",containerBorder:"1px solid lightgrey",containerBoxShadow:"0 4px 8px rgba(0, 0, 0, 0.2)",titleBoundaryColor:"lightgrey",buttonPrimaryBackgroundColor:`${{blue_5:"#2563eb"}.blue_5}`,buttonPrimaryColor:"white",buttonSecondaryBackgroundColor:"grey",buttonSecondaryColor:"white",buttonBorderRadius:"0"};class c extends o{_$title;_$message;_$ok;_$cancel;_resolve;_handleKeyDown;constructor(t,e,n,r){super(t);const{fontSize:a,containerBorder:s,containerBoxShadow:d,titleBoundaryColor:I,buttonPrimaryBackgroundColor:M,buttonPrimaryColor:H,buttonSecondaryBackgroundColor:R,buttonSecondaryColor:L,buttonBorderRadius:D}=r;this._$title=this.query("#title"),this._$message=this.query("#message"),this._$title.textContent=e,this._$message.textContent=n,this._$ok=this.query("#ok"),this._$cancel=this.queryOptional("#cancel"),this.applyStyles(`
			#container {
				font-size: ${a};
				border: ${s};
				box-shadow: ${d};
		...
		`),this._$ok.onclick=()=>{this.remove(),this._resolve?.(!0),this._resolve=void 0},this._$cancel&&(this._$cancel.onclick=()=>{this.remove(),this._resolve?.(!1),this._resolve=void 0}),this._handleKeyDown=f=>{f.key==="Enter"?this._$ok.click():f.key==="Escape"&&(this._$cancel?this._$cancel.click():this._$ok.click())},window.addEventListener("keydown",this._handleKeyDown),document.body.appendChild(this)}static alert(t,e="",n={}){return this._create(E,t,e,n)}static confirm(t,e="",n={}){return this._create(C,t,e,n)}static _create(t,e,n,r){const a={...S,...r};return new Promise(s=>{const d=new c(t,n,e,a);d._resolve=s})}}customElements.define("aero-popup",c),i.AeroNumericInput=g,i.AeroOption=v,i.AeroPopup=c,i.AeroProgressSpinner=m,i.AeroResizableBox=l,i.AeroSelect=_,i.AeroSpinbox=b,i.AeroToast=u,Object.defineProperty(i,Symbol.toStringTag,{value:"Module"})}));
